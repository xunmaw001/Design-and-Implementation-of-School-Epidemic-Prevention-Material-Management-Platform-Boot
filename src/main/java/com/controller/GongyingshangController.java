...
//        if(false)
//            return R.error(511,"永远不会进入");
        if("".equals(gongyingshang.getLianxirenFile()) || "null".equals(gongyingshang.getLianxirenFile())){
                gongyingshang.setLianxirenFile(null);
        }
...
//                            gongyingshangEntity.setLianxirenFile(data.get(0));                    //供应合同 要改的
