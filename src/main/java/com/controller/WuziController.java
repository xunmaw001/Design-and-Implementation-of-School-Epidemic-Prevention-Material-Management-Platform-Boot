    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(wuzi !=null){
            ...
            //级联表 供应商信息
            //级联表
            GongyingshangEntity gongyingshang = gongyingshangService.selectById(wuzi.getGongyingshangId());
    ...
    */
    ...
    public R save(@RequestBody WuziEntity wuzi, HttpServletRequest request){
        ...
        Wrapper<WuziEntity> queryWrapper = new EntityWrapper<WuziEntity>()
            .eq("gongyingshang_id", wuzi.getGongyingshangId())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            WuziEntity wuziEntity = new WuziEntity();
//                            wuziEntity.setGongyingshangId(Integer.valueOf(data.get(0)));   //供应商 要改的
...
//                            wuziEntity.setWuziNewMoney(data.get(0));                    //价格 要改的
