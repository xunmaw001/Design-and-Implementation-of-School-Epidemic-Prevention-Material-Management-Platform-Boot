...
public class GongyingshangEntity<T> implements Serializable {
     ...
     * 供应合同
     */
    @ColumnInfo(comment="供应合同",type="varchar(200)")
    @TableField(value = "lianxiren_file")

    private String lianxirenFile;
	 ...
	 * 获取：供应合同
	 */
    public String getLianxirenFile() {
        return lianxirenFile;
    }
    /**
	 * 设置：供应合同
	 */

    public void setLianxirenFile(String lianxirenFile) {
        this.lianxirenFile = lianxirenFile;
    }
    /**
	 * 获取：供应商类型
	 */
