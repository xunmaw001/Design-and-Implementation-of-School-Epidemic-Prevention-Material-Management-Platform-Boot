        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanyiqingwuziguanli/upload/gongyingshangMuBan.xls"
                        >批量导入供应商信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gongyingshang','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="lianxirenFile"
                                     header-align="center"
                                     width="200"
                                     label="供应合同">
                        <template slot-scope="scope">
                            <div v-if="scope.row.lianxirenFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.lianxirenFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
