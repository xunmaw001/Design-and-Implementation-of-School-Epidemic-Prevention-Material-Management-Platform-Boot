    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分配数量" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="分配数量" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="分配数量" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="分配数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="wuziOrderTruePrice">
                       <el-input v-model="ruleForm.wuziOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.wuziOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="wuziOrderTruePrice">
                           <el-input v-model="ruleForm.wuziOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="wuziOrderTypes">
                        <el-select v-model="ruleForm.wuziOrderTypes" :disabled="ro.wuziOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in wuziOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="wuziOrderValue">
                        <el-input v-model="ruleForm.wuziOrderValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    buyNumber: false,
                    wuziOrderTruePrice: false,
                    wuziOrderTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    wuziId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzi_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wuziOrderTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`wuziOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuziOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
